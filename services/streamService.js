...
const downloadSubtitles = function (imdbID, lang) {
  return new Promise(async (resolve) => {
    const opensubtitles_config = {
      useragent: process.env.OPENSUBTITLES_CONFIG_USERAGENT,
      username: process.env.OPENSUBTITLES_CONFIG_USERNAME,
      password: process.env.OPENSUBTITLES_CONFIG_PASSWORD,
    };
